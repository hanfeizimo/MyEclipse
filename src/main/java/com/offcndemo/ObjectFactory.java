 ...
 * generated in the com.offcndemo package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetValueResponse_QNAME = new QName("http://offcndemo.com/", "getValueResponse");
    private final static QName _GetValue_QNAME = new QName("http://offcndemo.com/", "getValue");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.offcndemo
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://offcndemo.com/", name = "getValueResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://offcndemo.com/", name = "getValue")
