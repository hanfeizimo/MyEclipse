 ...
 * 
 */
@WebServiceClient(name = "demoServiceService", targetNamespace = "http://offcndemo.com/", wsdlLocation = "http://localhost:9001/Service/qwe?wsdl")
    ...
    extends Service
{
    ...
    private final static QName DEMOSERVICESERVICE_QNAME = new QName("http://offcndemo.com/", "demoServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9001/Service/qwe?wsdl");
    ...
    public DemoService getDemoServicePort() {
        return super.getPort(new QName("http://offcndemo.com/", "demoServicePort"), DemoService.class);
    }
    ...
    public DemoService getDemoServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://offcndemo.com/", "demoServicePort"), DemoService.class, features);
    }
